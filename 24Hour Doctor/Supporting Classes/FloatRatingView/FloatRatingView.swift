...
open class FloatRatingView: UIView {
    ...
    */
    ...
    @IBInspectable open var maxImageSize: CGSize = CGSize(width: 50.0, height: 20.0)
    ...
    */
    ...
    override open func layoutSubviews() {
        ...
        let maxImageWidth = max(minImageSize.width, maxImageSize.width)
        let maxImageHeight = max(minImageSize.height, maxImageSize.width)
